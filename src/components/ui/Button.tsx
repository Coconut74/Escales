...
const variantClasses: Record<Variant, string> = {
  ...
  'grey-outline': 'bg-transparent text-neutral-500 dark:text-neutral-400 border border-neutral-200 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 active:bg-neutral-100 dark:active:bg-neutral-700',
}
